...
export class BaseFastGroupsModeChanger extends RgthreeBaseVirtualNode {
    constructor(title = ShouWangDisableMultiGroups.title) {
        super(title);
...
BaseFastGroupsModeChanger.title = "守望-禁用多组🐢";
BaseFastGroupsModeChanger.exposedActions = ["全部禁用", "全部启用", "全部切换"];
...
export class ShouWangDisableMultiGroups extends BaseFastGroupsModeChanger {
    constructor(title = ShouWangDisableMultiGroups.title) {
        super(title);
...
ShouWangDisableMultiGroups.type = NodeTypesString.FAST_GROUPS_MUTER;
ShouWangDisableMultiGroups.title = "守望-禁用多组🐢";
ShouWangDisableMultiGroups.exposedActions = ["全部禁用", "全部启用", "全部切换"];
ShouWangDisableMultiGroups._category = "守望🐢/工具";
...
app.registerExtension({
    name: "ShouWang.FastGroupsMuter",
    registerCustomNodes() {
        ShouWangDisableMultiGroups.setUp();
    },
    beforeRegisterVueAppNodeDefs(defs) {
        const def = defs.find((d) => d.name === NodeTypesString.FAST_GROUPS_MUTER);
        if (def) {
            def.display_name = "守望-禁用多组🐢";
            def.category = "守望🐢/工具";
        }
    },
    loadedGraphNode(node) {
        if (node.type == ShouWangDisableMultiGroups.type) {
